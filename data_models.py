...
# These dictionaries represent the questions and career data.
# Based on Career Questions1.xlsx and Career Questions Path.xlsx.

# Define the traits you are measuring (RIASEC model)
TRAITS = ["Investigative", "Artistic", "Realistic", "Social", "Enterprising", "Conventional"]

# Question Structure: Each question maps options to traits and scores
QUESTIONS = {
    "1": {
...
# Example Career Structure (unchanged from original for now)
CAREERS = {
    "SWE": {
